...
var _global_scopes = require('./global_scopes');

var _global_scopes2 = _interopRequireDefault(_global_scopes);
...
var Models = function Models(sequelize, DataTypes) {
  ...
  this.scopes = (0, _scopes2.default)(sequelize, DataTypes);
  this.users = (0, _users2.default)(sequelize, DataTypes);
  this.globalScopes = (0, _global_scopes2.default)(sequelize, DataTypes);
